...
/// @notice Core-behaviour suite for `NFTStakerDepletionV2` — the bug-fixed
///         hand-maintained successor of `NFTStakerDepletion` (story-026,
///         audit-21 M-03). Mirrors `test/NFTStakerDepletion.t.sol` so V2's
///         non-depositFor behaviour is proven identical to the frozen V1.
///         Proves: constructor wiring, the owner-set
...
contract NFTStakerDepletionV2Test is Test {
